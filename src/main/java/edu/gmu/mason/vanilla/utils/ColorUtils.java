...
public class ColorUtils {
	...
	private static Map<Integer, Color> agentInfectionColorMap;
	...
	public static Map<Integer, Color> getAgentInfectionColorMap(){
		if (agentInfectionColorMap == null) {
			agentInfectionColorMap = new HashMap<Integer, Color>();
			agentInfectionColorMap.put(0, new Color(0, 0, 255));
			agentInfectionColorMap.put(1, new Color(255, 0, 0));

		}
		return agentInfectionColorMap;
	}
}
