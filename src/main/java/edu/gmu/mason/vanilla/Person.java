...
import edu.gmu.mason.vanilla.utils.InstructionQueue;
...
public class Person implements Steppable, java.io.Serializable {
	 ...
	 * @param id
	 */
	public Person(WorldModel model, long id, BuildingUnit diseaseSource) { // single agent initialization
		this(model, id, null, diseaseSource);
	}
	 ...
	 * @param family
	 */
	public Person(WorldModel model, long id, Family family, BuildingUnit diseaseSource) {
...
//		if(journalEnabled)
	...
	public boolean getInfected(){return isInfected;}
	public void setInfected(boolean isInfected){

		this.isInfected=isInfected;
	}
	public ArrayList<DailyTrack> getTrack(){
		return trackTrace.getTrack();
	}
