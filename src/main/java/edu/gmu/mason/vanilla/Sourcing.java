...
public class Sourcing {
    ...
    public String getString(double foundPos, long foundPosId, long sourceId, int placeRank, double placeRatio,
            double ratio1, double ratio2, double ratio3, WorldParameters params) {
        // double with 2 decimal places
        String result = String.format("%.2f", foundPos) + ", " + foundPosId + ", " + sourceId + ", " + placeRank + ", "
                + String.format("%.2f", placeRatio) + ", " + String.format("%.2f", ratio1) + ", "
                + String.format("%.2f", ratio2) + ", " + String.format("%.2f", ratio3) + ", " + "[" + params.numOfAgents
